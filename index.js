...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        // append/add the game to the games-container
...
function filterUnfundedOnly() {
    ...
    const listOfUnmetGoals = GAMES_JSON.filter ((game) => {
        return game.pledged < game.goal;
    });

    // use the function we previously created to add the unfunded games to the DOM
    addGamesToPage(listOfUnmetGoals);
}
...
function filterFundedOnly() {
    ...
    const listOfMetGoals = GAMES_JSON.filter((game) => {
        return game.pledged >= game.goal;
    });

    // use the function we previously created to add unfunded games to the DOM
    addGamesToPage(listOfMetGoals);
}
...
const paragraph = document.createElement('p'); //create
paragraph.innerHTML = displayStr; //put in display
descriptionContainer.appendChild(paragraph); //add it to the paragraph
/************************************************************************************
